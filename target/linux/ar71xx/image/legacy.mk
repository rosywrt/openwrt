...
rs_wr818_mtdlayout_16M=mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,1472k(kernel),14464k(rootfs),64k(factory),64k(art)ro,15936k@0x50000(firmware)
...
$(eval $(call SingleProfile,AthLzma,64k,RS_WR818_16M,rs-wr818-16M,RS-WR818,ttyS0,115200,$$(rs_wr818_mtdlayout_16M),KRuImage))
